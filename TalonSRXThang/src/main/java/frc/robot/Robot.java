...
public class Robot extends TimedRobot {
    ...
    private static final double KP = 0.01; // Increase for a stronger response
    private static final double KI = 0.0001; // Small integral gain
    private static final double KD = 0.0005; // Derivative gain for smooth control
    ...
    public void teleopPeriodic() {
        ...
        double precisionScaling = 30.0; // Adjust max angle change per second
